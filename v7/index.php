...
<section class="features">
  ...
  <div class="feature-grid">
    ...
    <div class="feature-card">
      ...
      <p>Advanced OCR scanning, grammar validation, and structure analysis using DistilBERT.</p>
    </div>
    <div class="feature-card">
  ...
  <div class="role-grid">
    <div class="role-card">
      ...
      <div class="feature-item">
        ...
        <p><span class="material-icons check">check_circle</span> Real-time communication with advisers</p>
      </div>
    </div>
    ...
    <div class="role-card">
      ...
      <div class="feature-item">
        ...
        <p><span class="material-icons check">check_circle</span> Approve adviser registrations</p>
        <p><span class="material-icons check">check_circle</span> Assign advisers to sections</p>
  ...
  <div class="ai-container">
    ...
    <div class="ai-features">
      <div class="ai-feature-item">
        <span class="material-symbols-outlined ai-icon">neurology</span>
        <div>
          <h4>OCR Text Extraction</h4>
          <p>Advanced OCR technology converts uploaded PDFs to text for comprehensive analysis and validation.</p>
        </div>
      </div>
    ...
    <div class="ai-analysis-box">
      ...
      <button class="ai-btn">Experience AI Analysis</button>
    </div>
  </div>
</section>
