...
function analyzeDocumentWithAI($filePath, $chapter_number = 1) {
    $ai_api_url = "https://melonas-ai-content-detector.hf.space/analyze-pdf";
    $thesis_api_url = "https://melonas-main-function.hf.space/analyze-pdf";
    $citation_api_url = "https://melonas-apa-citation-checker.hf.space/analyze-pdf";
    $spelling_grammar_api_url = "https://melonas-spelling-grammar-checker.hf.space/check-file/";
...
function analyzeDocumentFormatting($filePath, $chapter_number) {
    $python_api_url = "https://melonas-formatting-analysis.hf.space/analyze-formatting";
